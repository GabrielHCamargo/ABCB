...
async def create_configs_database(db):
    async with db as session:
        with open('C:/Projects/SERVER-ABCB/.codes/.csv/Status_Codes.csv', newline='', encoding='utf-8') as status_codes_file:
        ...
        with open('C:/Projects/SERVER-ABCB/.codes/.csv/Customers_Events_Codes.csv', newline='', encoding='utf-8') as customers_events_codes_file:
